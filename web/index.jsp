<%-- 
    Document   : governanca
    Created on : 17/10/2017, 09:27:18
    Author     : caretronics
--%>
...
<%@ include file="ladoEsquerdo.jsp" %>
            ...
            <div id="conteudo">
                <h1>História do Grêmio Foot-Ball Porto Alegrense</h1>

                <h2>Futebol Porto-Alegrense</h2>
 
                <p id="corAzul">Grêmio: associação ou união de um grupo de pessoas em torno de um mesmo ideal ou objetivo.</p>
